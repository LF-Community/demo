...
// file://home/revol-xut/workspace/lf/demo/src/Main.lf
#define LOG_LEVEL 2
...
void lf_create_environments() {
    environment_init(&envs[main_main],"Main",main_main,_lf_number_of_workers,0,1,0,0,0,0,0,0,NULL);
}
